...
This RCA document should be used by `/lril:implement-fix` command.

## Next Steps

1. Review this RCA document
2. Run: `/lril:implement-fix $ARGUMENTS` to implement the fix
3. Run: `/lril:commit` after implementation complete
```
