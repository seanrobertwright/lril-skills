...
```
${CLAUDE_PLUGIN_ROOT}/commands/content-youtube.md
${CLAUDE_PLUGIN_ROOT}/commands/content-linkedin.md
${CLAUDE_PLUGIN_ROOT}/commands/content-x.md
${CLAUDE_PLUGIN_ROOT}/commands/content-shorts.md
```
